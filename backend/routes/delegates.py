...
def register_delegate():
    ...
    # If free slot, send credentials immediately
    if is_free:
        try:
    ...
    return jsonify({
        ...
        'message': 'Registration successful! Credentials sent to email.' if is_free else 'Registration received. Please complete payment.'
    }), 201
