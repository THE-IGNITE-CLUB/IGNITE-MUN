...
- **Frontend**: React 18, Vite, React Router DOM, Tailwind CSS v3, Framer Motion, Axios, React Hot Toast, QRCode.react.
...
- **SVU Campus & Hybrid Diplomacy Pages**: Interactive maps, committee details (UNSC & Lok Sabha), background paper access.
- **Super Admin Panel**: Full command center for delegate & organizer credentials management.
